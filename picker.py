...
class Browser(Picker):
    ...
    def show(self):
        ...
        back_path = file_utils.get_path_head(self.current_path)
        options = file_utils.get_entries_in_directory(self.current_path, include_hidden=is_browser_hidden_files)
        start_index = 0
